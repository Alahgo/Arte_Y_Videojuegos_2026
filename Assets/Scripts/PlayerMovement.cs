...
public class PlayerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        if (Scene2ManagerScript.instance != null && !Scene2ManagerScript.instance._moveIsPaused)
        {
            rb.linearVelocity = moveInput * speed;
        }
        else if (Scene2ManagerScript.instance != null && Scene2ManagerScript.instance._moveIsPaused)
        {
